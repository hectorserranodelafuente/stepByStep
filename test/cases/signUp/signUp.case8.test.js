...
const { Case }  = require('../../case.js')
    ...
    main(processArgv,socket){
        ...
        this.auxGetConfirmationToken( 'prueba-3@mailinator.com', processArgv ).then(response=>{
            ...
            let res3 = new Emulate('case 15','We confirm third user signUp successfully','html','has being successfull signedUp', scope.case.resolves[scope.case.index], socket,14)
